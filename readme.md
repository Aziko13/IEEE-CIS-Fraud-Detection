...
This project is for Kaggle competition. The problem is to identify fraud transactions. 
All details can be found [here] [https://www.kaggle.com/c/ieee-fraud-detection/submissions]

## Getting Started

Solution gives 44th place out of 6438 (top 1%, silver). The main idea is to identify UserID 
